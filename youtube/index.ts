class YoutubeVideo{
  ...
  //INSTANCE OF YoutubeVideo Class.
  let actionVideo=new YoutubeVideo("SuperDooper",95999979,50000,68699,7000,"juke Dock",110,"BOLLYWOOD","1 jan 2018","Standard YouTube Licence",[{"name":"kiran","comment":"wow what a video"},{"name":"jatin","comment":"ek no."}],"Salman khan","Katrina Kaif","Tiger zinda hai","https://geetmp3.lnk.to/tiger");
  
  //INSTANCE OF YoutubeVideo Class.
  let funnyVideo=new YoutubeVideo("Madaras central",1000,50000,188,7000,"Best Fun",134,"BOLLYWOOD","30,nov 2017","Standard YouTube Licence",[{"name":"wow","comment":"nice"},{"name":"nidhi","comment":"brilliant"}]);
